...
final class QRCodeEncoder {
    ...
    QRCodeEncoder(Context activity, Intent intent, int dimension, boolean useVCard) throws Exception {
    ...
    private void encodeContentsFromShareIntent(Intent intent) throws Exception {
    ...
    private void encodeFromTextExtras(Intent intent) throws Exception {
